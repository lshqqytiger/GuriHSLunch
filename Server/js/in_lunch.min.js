...
const date = new Date();
let month = date.getMonth()+1 < 10 ? "0" + date.getMonth()+1 : date.getMonth()+1 // Regardless of type of getMonth()
let day = date.getDate() < 10 ? "0" + date.getDate() : date.getDate() // also regardless of that
